...
use crate::{
    component::{ComponentTicks, Resource},
    ptr::PtrMut,
};
...
pub trait DetectChanges {
    ...
    /// Returns the change tick recording the previous time this component (or resource) was
    /// changed.
    ///
...
impl<'a> MutUntyped<'a> {
    ...
    ///
    /// In order to mark the value as changed, you need to call
    /// [`set_changed`](DetectChanges::set_changed) manually.
